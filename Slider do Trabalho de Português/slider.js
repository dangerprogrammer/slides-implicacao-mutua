...
addEventListener('keydown', ev => {
    if (ev.code === 'ArrowRight' || ev.code === 'Enter') generateNext();
    else if (ev.code === 'ArrowLeft') generatePrev();
});
...
function slide4() {
    ...
    const sinedoqueTitle = createTitle(
        ...
        {top: '5%'}
            ...
            {top: '30%', left: '50%', transform: 'translate(-50%, -50%)', width: '80vw'}
        );
